...
#ifndef MEAN_SQUARE_LOSS_OP_H_
#define MEAN_SQUARE_LOSS_OP_H_
...
class MeanSquareLossOp final : public Operator<Context> {
 public:
...
template <typename T, class Context>
class MeanSquareLossGradientOp final : public Operator<Context> {
 public:
