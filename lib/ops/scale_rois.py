...
class ScaleRoIsFPNOp(object):
    """ Scale the rois by a factor up_scale and 
        ...
        inputs: [data, rois_fpn<min>, ... , rois_fpn<max> ]
        outputs: [pad_rois_fpn<min>, ... , pad_rois_fpn<max> ]
    """
    def __init__(k_min, k_max, up_scale):
        self.k_min = k_min
        self.k_max = k_max
        self.up_scale = up_scale
